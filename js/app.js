...
function outputRecipe() {
  ...
  servingAmount.innerText = `Antall porsjoner: ${needsToServe.value}`;
...
function addRow() {
  ...
  inputQuantity.placeholder = 'Antall';
  ...
  const measurements = {
    volume: [
      { name: 'Kopper', value: 'cups' },
      { name: 'Spiseskjeer', value: 'Tbsp' },
      { name: 'Teskjeer', value: 'tsp' },
